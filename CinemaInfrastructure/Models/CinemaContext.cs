...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasIndex(e => e.SeatId, "IX_Bookings_SeatId");

            entity.HasIndex(e => e.SessionId, "IX_Bookings_SessionId");
        ...
        modelBuilder.Entity<Film>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyId, "IX_Films_CompanyId");

            entity.HasIndex(e => e.FilmCategoryId, "IX_Films_FilmCategoryId");
        ...
        modelBuilder.Entity<FilmRating>(entity =>
        {
            ...
            entity.HasIndex(e => e.FilmId, "IX_FilmRatings_FilmId");

            entity.HasIndex(e => e.ViewerId, "IX_FilmRatings_ViewerId");
        ...
        modelBuilder.Entity<Hall>(entity =>
        {
            ...
            entity.HasIndex(e => e.HallTypeId, "IX_Halls_HallTypeId");
        ...
        modelBuilder.Entity<Seat>(entity =>
        {
            ...
            entity.HasIndex(e => e.HallId, "IX_Seats_HallId");
